...
const StudentDashboard = () => {
  ...
  try {
    ...
    // 🔥 Manejo unificado de estructuras de respuesta
    let userIncidents = [];
    ...
    console.log("📋 Incidencias del usuario:", userIncidents);
    ...
    alert("Error al cargar las incidencias. Verifica la consola para más detalles.");
  } finally {
    setLoading(false);
  }
};
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-ucv-white text-opacity-90 mt-1">
                Reporta un nuevo problema técnico
              </p>
            </div>
          </div>
        </Link>
