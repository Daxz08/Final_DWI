    ...
    public class ReportController {
        ...
        @GetMapping("/employee/{employeeId}/reports")
        ...
        // 🔥 AGREGAR estos endpoints al ReportController

        @GetMapping("/employee/{employeeId}/all")
        public ResponseEntity<ApiResponse<List<Report>>> getAllReportsByEmployee(@PathVariable Long employeeId) {
            try {
                List<Report> reports = reportService.getReportsByEmployeeId(employeeId);
                return ResponseEntity.ok(ApiResponse.success(reports));
            } catch (Exception e) {
        ...
        @GetMapping("/incident/{incidentId}/has-report")
        public ResponseEntity<ApiResponse<Boolean>> hasReportForIncident(@PathVariable Long incidentId) {
            try {
                boolean hasReport = reportService.existsByIncidentId(incidentId);
                return ResponseEntity.ok(ApiResponse.success("Verificación completada", hasReport));
            } catch (Exception e) {
                return ResponseEntity.badRequest().body(ApiResponse.error(e.getMessage()));
            }
        }
